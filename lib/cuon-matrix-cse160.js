...
class Vector3 {
    ...
    static cross(other1, other2) {
        // Insert your code here.
        let x = other1.elements[1] * other2.elements[2] - other2.elements[1] * other1.elements[2]
        let y = other2.elements[0] * other1.elements[2] - other1.elements[0] * other2.elements[2]
        let z = other1.elements[0] * other2.elements[1] - other2.elements[0] * other1.elements[1]
